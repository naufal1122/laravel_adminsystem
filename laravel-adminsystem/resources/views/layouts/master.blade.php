...
<head>
    ...
    <title>System Profile || Naufal Dewa</title>
    <link rel="shortcut icon" href="{{ URL::to('assets/images/logo/logo1.png') }}">
    ...
    <link rel="shortcut icon" href="{{ URL::to('assets/images/logo/logo1.png') }}" type="image/x-icon">
...
<body>
    ...
    <div class="preloader">
        <div class="loading">
            <img src="assets/images/logo/loading.gif" width="80">
            <p>Harap Tunggu</p>
        </div>
    </div>
