        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <!-- Add icons to the links using the .nav-icon class
              ...
              <a href="/penduduk" class="nav-link active"> <?php if($page=='dashboard')?>
            ...
            <li class="nav-item ">
              <a href="/penduduk/create" class="nav-link"> <?php if($page=='form_input'){echo 'active';} ?>
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Dewantoro Naufal</h3>

                <p class="text-muted text-center">Teknik Informatika UNS `21</p>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                  Teknik Informatika Universitas Sebelas Maret `21
                </p>
                ...
                <p class="text-muted">Lalung, Karanganyar</p>
                ...
                <p class="text-muted">
                  <span class="tag tag-danger">Kuliah</span>
                  <span class="tag tag-success">Makan</span>
                  <span class="tag tag-info">Tidur</span>
                  <span class="tag tag-warning">Ngoding</span>
                  <span class="tag tag-primary">Kuliah Lagi</span>
                </p>
                ...
                <p class="text-muted">Jangan lupa makan dan jangan lupa tidur siang.</p>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post clearfix">
                      ...
                      <!-- /.user-block -->
                      <p>
                        Halo Bro, jangan lupa tidur siang.
                      </p>
                    ...
                    <div class="post">
                      <div class="user-block">
                        ...
                        <span class="username">
                          <a href="#">Saudaranya Naufal Dewa</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
                        <span class="description">Posted 5 photos - 5 days ago</span>
                      </div>
                      <p>
                        Nih boss foto buat cuci mataaa...
                      </p>
                      <!-- /.user-block -->
                      <div class="row mb-3">
                        <div class="col-sm-6">
